class StudentDetailsController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to student_details_path, status: :see_other, notice: "Student detail was successfully destroyed." }
  ...
  private
    ...
    def set_student_detail
      @student_detail = StudentDetail.find(params.expect(:id))
    end

    # Only allow a list of trusted parameters through.
    def student_detail_params
      params.fetch(:student_detail, {})
    end
end
